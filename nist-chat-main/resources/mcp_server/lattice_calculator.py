...
def SpecWhere(M2_deg: float,S1_deg: float,S2_deg: float,A2_deg: float,EXP_list: list ,lattice_obj: list ,orientation_obj: list,instrument_obj: list):
...
@mcp.tool()
async def py_calculate_hkl_e_from_angles(crystal_system_str, abc_str, angles_str, 
                                   orient1_str, orient2_str, 
                                   fixed_field_str, efixed_val, 
                                   hkl_str, w_str):
    
    """  description="Calculate from the  (h, k, l) indices and energy transfer (E), the instrument angles and lattice parameters based on a specified crystal system.",
    inputs={
        "crystal_system_str": "The name of the crystal system (e.g., 'cubic', 'tetragonal', 'hexagonal', etc.).",
        "abc_str": "Comma-separated list of unit cell parameters a,b,c (e.g., '10.0,10.0,10.0').",
        "angles_str": "Comma-separated list of unit cell angles alpha,beta,gamma in degrees (optional, defaults to 90,90,90).",
        "orient1_str": "First orientation vector (comma-separated, e.g., '1,0,0').",
        "orient2_str": "Second orientation vector (comma-separated, e.g., '0,1,0').",
        "fixed_field_str": "Either 'EI' or 'EF' to indicate which energy is fixed.",
        "efixed_val": "The fixed energy value (default is 14.7).",
        "w_str": "energy loss(single float '0.0')"
    },
    outputs={
        "h": "The calculated Miller index h.",
        "k": "The calculated Miller index k.",
        "l": "The calculated Miller index l.",
        "e": "The energy transfer E.",
        "q": "The magnitude of the momentum transfer vector Q.",
        "ei": "The incident energy (Ei).",
        "ef": "The final energy (Ef).",
        "m2": "Instrument angle M2.",
        "s1": "Instrument angle S1.",
        "s2": "Instrument angle S2.",
        "a2": "Instrument angle A2.",
        "m1": "Instrument angle M1.",
        "a1": "Instrument angle A1."
    """
